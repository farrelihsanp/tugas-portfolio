function ItemAboutMe(props: any) {
  return (
    <div className="bg-white shadow-md rounded-lg w-80 h-80 p-4 text-center flex flex-col mx-4 flex-1 items-center justify-center hover:bg-gray-100 transition duration-300">
